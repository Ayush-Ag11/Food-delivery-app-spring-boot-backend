...
import com.project.backend.foodelicious.security.JwtAuthFilter;
...
// securedEnabled = true allows us to use @Secured("ROLE_ADMIN") on controller methods
